...
//                itemTableView.reloadData()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
             if let destination = segue.destination as? AddNotePopUpViewController {
...
//    }
    ...
    func loadTodos(with request: NSFetchRequest<ToDo> = ToDo.fetchRequest(), predicate: NSPredicate? = nil) {
        ...
        do {
            itemArray = try todoListContext.fetch(request)
        } catch {
    ...
    func deleteTodoFromList() {
        ...
        itemArray.removeAll { (Todo) -> Bool in
            Todo == selectedTodo!
        }
        itemTableView.reloadData()
    ...
    override func tableView(_ tableView: UITableView, trailingSwipeActionsConfigurationForRowAt indexPath: IndexPath) -> UISwipeActionsConfiguration? {
        let delete = UIContextualAction(style: .destructive, title: "Delete") { (action, view, completion) in
            ...
            self.todoListContext.delete(self.itemArray[indexPath.row])
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        selectedTodo = itemArray[indexPath.row]
        performSegue(withIdentifier: "PopUpVC", sender: self)
    }
